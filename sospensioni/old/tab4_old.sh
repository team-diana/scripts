...
rostopic pub /motore_1_controller/command std_msgs/Float64 "data: 2" -1

rostopic pub /motore_2_controller/command std_msgs/Float64 "data: 3.14" -1

rostopic pub /motore_3_controller/command std_msgs/Float64 "data: 4" -1
...
rostopic pub /motore_2_controller/command std_msgs/Float64 "data: 2" -1

rostopic pub /motore_3_controller/command std_msgs/Float64 "data: 3.14" -1

rostopic pub /motore_4_controller/command std_msgs/Float64 "data: 4" -1
